...
class SupabaseService {
  ...
  static Future<void> updateProduct(
      int id, String name, String price, String quantity) async {
    try {
  ...
  // 🔥 SELL PRODUCT (FIXED + SAFE)
  static Future<String> sellProduct(int id) async {
    try {
  ...
  // 🟢 ADD SALE (MANUAL / BULK SELL)
  static Future<void> addSale(String name, int qty) async {
    try {
      await supabase.from('sales').insert({
        'product_name': name,
        'quantity': qty,
